...
The 1200×630 social preview added on 2026-09-06 is a center crop of that original source. The 180px Apple touch icon is resized from the hand-authored app icon. Both derivatives are local and use the `sf-payout-reconciliation-casefile-*` filename prefix.
