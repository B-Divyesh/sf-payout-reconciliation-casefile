# Payout Reconciliation Casefile (`payout-reconciliation-casefile`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://payout-reconciliation-casefile.sociobot.in`. Artifact class: `pwa-offline`.
